...
class Movie {
  ...
  @override
  String toString() {
    return 'Movie(posterPath: $posterPath, id: $id, backdropPath: $backdropPath, totalResults: $totalResults, public: $public, revenue: $revenue, page: $page, results: $results, objectIds: $objectIds, iso6391: $iso6391, totalPages: $totalPages, description: $description, createdBy: $createdBy, iso31661: $iso31661, averageRating: $averageRating, runtime: $runtime, name: $name, comments: $comments)';
  }
}
